                ...
                output_file.write(f'''
                       <div class="auto-delete-container">
                        <div class="toggle-switch {'active' if AUTO_DELETE_ENABLED else ''}" 
                            ...
                            <div class="slider">
                                <svg class="icon-shield" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <svg class="icon-trash" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
